...
// Actions itself executes. Never import this from a script meant to run
// interactively (scripts/ruleset.mjs is that case and keeps its own
// gh-tsouza constant; it is never invoked by a workflow, only by a human or
// Claude Code locally, per Article VII.3).
import { $ } from "bun";
