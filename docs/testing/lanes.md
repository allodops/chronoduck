...
- **merge posture**: `hygiene` (the tree hygiene scans, L13), `build-test` (the release build and sqllogictest suite, L5), `duckdb-stable-build` and `code-quality-check` (the vendored distribution and format/tidy pipeline)
